...
The repository root is the exported web build (served by GitHub Pages); `source/` is the Godot project that produces it. Export file names (`index.*`) must stay as they are.

![Moss / Ink field study 03](docs/screenshot.jpg)
